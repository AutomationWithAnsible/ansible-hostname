ansible-hostname [![Build Status](https://travis-ci.org/AutomationWithAnsible/ansible-hostname.svg?branch=master)](https://travis-ci.org/AutomationWithAnsible/ansible-hostname)
=====================
